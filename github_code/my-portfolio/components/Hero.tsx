...
export default function Hero() {
  return (
    <section className="relative flex min-h-[calc(100vh-73px)] items-center justify-center bg-zinc-950 overflow-hidden">
      
      {/* Κεντρικό 3D Model */}
      <div className="absolute inset-0 z-0 flex items-center justify-center cursor-grab active:cursor-grabbing">
        <Spline scene="https://prod.spline.design/1HTMTd5bd3oJYwK3/scene.splinecode" />
      </div>

      {/* Wrapper Κειμένων - Βγάλαμε το max-w-7xl για να απλώσει σε όλη την οθόνη */}
